...
python evaluate.py --model_type cnsn [other options]
...
if __name__ == "__main__":
    ...
    print("python evaluate.py --model_type cnsn [other options]")
    print("="*80 + "\n")
    
    # Run the unified evaluation script with model_type=cnsn
    sys.argv.extend(['--model_type', 'cnsn'])
    main()
