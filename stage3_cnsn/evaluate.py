"""
Evaluation script for MobileNetV2 with Mish, Triplet Attention, and CNSN.
"""
import os
import argparse
import torch
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Evaluate MobileNetV2 with Mish, Triplet Attention, and CNSN')
    parser.add_argument('--data_dir', type=str, required=True,
                        help='Path to dataset directory')
    parser.add_argument('--checkpoint', type=str, required=True,
                        help='Path to model checkpoint')
    parser.add_argument('--output_dir', type=str, default='experiments/stage3_cnsn',
...
def main():
    ...
    # Set up logging
    setup_logging('stage3_cnsn_eval', 'logs')
    ...
    with open(report_path, 'w') as f:
        f.write(f"Model: MobileNetV2 with Mish, Triplet Attention, and CNSN\n")
