...
python train.py --model_type triplet [other options]
...
if __name__ == "__main__":
    ...
    print("python train.py --model_type triplet [other options]")
    print("="*80 + "\n")
    
    # Run the unified training script with model_type=triplet
