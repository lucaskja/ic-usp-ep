...
python evaluate.py --model_type triplet [other options]
...
if __name__ == "__main__":
    ...
    print("python evaluate.py --model_type triplet [other options]")
    print("="*80 + "\n")
    
    # Run the unified evaluation script with model_type=triplet
    sys.argv.extend(['--model_type', 'triplet'])
    main()
