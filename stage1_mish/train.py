"""
Training script for MobileNetV2 with Mish activation.
"""
import os
import argparse
import torch
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Train MobileNetV2 with Mish')
    parser.add_argument('--data_dir', type=str, required=True,
                        help='Path to dataset directory')
    parser.add_argument('--output_dir', type=str, default='experiments/stage1_mish',
...
def main():
    ...
    # Set up logging
    setup_logging('stage1_mish', 'logs')
    ...
    # Create model
    model = MobileNetV2MishModel(num_classes, pretrained=args.pretrained)
