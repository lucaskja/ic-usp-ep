...
from evaluation.evaluator import MobileNetV2Evaluator
from configs.default_config import DATA_CONFIG


def parse_args():
    """Parse command line arguments."""
    parser = argparse.ArgumentParser(description='Evaluate Base MobileNetV2')
...
def main():
    ...
    # Set up logging
    setup_logging('base_mobilenetv2_eval', 'logs')
