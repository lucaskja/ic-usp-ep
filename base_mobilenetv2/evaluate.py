...
python evaluate.py --model_type base [other options]
...
if __name__ == "__main__":
    ...
    print("python evaluate.py --model_type base [other options]")
    print("="*80 + "\n")
    
    # Run the unified evaluation script with model_type=base
